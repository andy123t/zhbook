...
自定义一个命令 \verb|\red{文字}| 来\red{加红文字}, 在文稿修改阶段方便标记.

这是一个文献引用的示例 \cite{Tadmor2012} 和 \cite{LiLiu1997,Adams2003,TreWei2014}.

\section{系统要求}
本模板 \href{https://github.com/andy123t/zhbook}{\texttt{zhbook}} 基于标准文类 ctexbook\index{ctexbook} 设计, 所以 ctexbook 文类的选项也能传递给本模板, 比如 \lstinline{openany, twoside} 等. 本模板可以在目前主流的 \href{https://en.wikibooks.org/wiki/LaTeX/Introduction}{\LaTeX{}} 编译系统中使用, 如 \TeX{}Live 和 MiK\TeX{}. 因 C\TeX{} 套装已停止维护, \textbf{不再建议使用}.
