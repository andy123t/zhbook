...
LaTeX 的 table 环境是一个浮动体\index{浮动体}环境, 排版与 figure 环境类似. 作为书籍, 推荐使用三线表进行排版. 一般的三线表\index{三线表}, 标题前后有横线, 表格最后有横线. %当然也可以根据需要在合适的地方加线.
...
基于 tabularx 环境设置表格, 如表~\ref{tab:bookpub}.

\begin{table}[htp!]
\centering
%\renewcommand\arraystretch{1.1} %定义表格高度
% PLCR前面已经定义
\caption{图书的出版流程}\label{tab:bookpub}
\begin{tabularx}{0.92\textwidth}{|P{2.5cm}|C|}
\Xhline{2\arrayrulewidth}
阶段       &  筹备过程 \\
\hline
第一阶段    & 作者申报选题, 编辑审稿, 并向编辑部提交选题策划书. \\
\hline
第二阶段    &  进行选题论证, 参与论证的是编辑、发行
人员、总编. \\
\hline
第三阶段   &  \makecell{通过了选题论证和出版局审核, 编辑就可以跟作者\\ 签订出版合同.}  \\
\hline
第四阶段    &  编辑、校对、设计. \\
\hline
第五阶段   &  申请书号, 征订和印刷.  \\
