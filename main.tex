...
% 正文前后没有空白页
\documentclass[openany,zihao=-4]{zhbook}

% 正文前加空白页, 正文没有空白页
%\documentclass[print,openany,zihao=-4]{zhbook}

% 正文前加空白页, 正文一章结束可空白页使新的一章是在奇数页开始
%\documentclass[print,twoside,openright,zihao=-4]{zhbook}
